    ...
    def get_followers(self, users, amount):
        ...
        for user in users:
            ...
            followers_button = browser.find_element_by_xpath(
                '/html/body/div[1]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/section/main/div/ul/li[2]/a/div/span')
            ...
            try:
                for i in range(1, loops_count + 1):
                    ...
                    for us in all_div:
                        us = us.find_element_by_tag_name(
                            "a").get_attribute("href")
                        if result == 'usernames':
                            us1 = us.replace("https://www.instagram.com/", "")
                            us = us1.replace("/", "")
                        followers_list.add(us)
                    time.sleep(1)
                    f3 = open('profile1.txt', 'w')
